...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('adminthuonghieu')}}"> Danh sách thương hiệu</a></li>
        <li class="active">Sữa </li>
    </ol>
</section>
<section class="content">
    <div class="box box-primary">
        <form id="form-add-post" class="formcategory-add-insurance-company validate" method="post" action="{{route('edithuonghieu',$trademark->id)}}" enctype="multipart/form-data">
            @csrf
            <div class="box-header with-border">
                <h3 class="box-title">Sửa  bài viết thương hiệu</h3>
            </div>
            <div class="box-body">
                                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active" id="vi" role="tabpanel" aria-labelledby="vi-tab">
                                <div class="form-group">
                                   ...
                                   {{--  <input id="title_vi" name="title_vi" required type="text" value="{{$trademark->tieude}}" class="form-control" placeholder="Nhập tiêu đề bài viết (VI)"onchange="changeInput(this.value)"> --}}
                                    <textarea name="title_vi" class="form-control ckeditor" placeholder="Nhập tiêu đề bài viết (VI)" value="" onchange="changeInput(this.value)">{!!$trademark->tieude!!}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Mô tả (VI)</label>
                                    <textarea name="summary_vi" class="form-control ckeditor" placeholder="Nhập mô tả bài viết (VI)" value="">{!!$trademark->mota!!}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nội dung (VI) (*)</label>
                                    <textarea name="data_vi" class="form-control ckeditor" placeholder="Nhập mô tả bài viết (VI)" value="">{!!$trademark->noidung!!}</textarea>
                                </div>
                            ...
                            <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                                <div class="form-group">
                                    ...
                                    <input id="title_en" name="title_en" required type="text" value="{{$trademark->tieude_en}}" class="form-control" placeholder="Nhập tiêu đề bài viết (EN)">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Mô tả (EN)</label>
                                    <textarea name="summary_en" class="form-control" placeholder="Nhập mô tả bài viết (EN)">{!!$trademark->mota_en!!}</textarea>
                                    
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nội dung (EN) (*)</label>
                                    <textarea name='data_en' class="form-control" placeholder="Nhập mô tả bài viết (EN)">{!!$trademark->noidung_en!!}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <img src="project1/images/{{$trademark->image}}" alt="" class="preview-feature-image preview-image"/>
                        </div>
                        <div class="form-group">
            ...
            <div class="box-footer">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right"><button type="submit" class="btn btn-primary">Sửa</button></div>
                    <div class="col-md-6 text-left"><a id="btnBack" href="{{route('adminthuonghieu')}}" class="btn btn-default">Hủy</a></div>
                </div>
            </div>
        </form>
    </div>
