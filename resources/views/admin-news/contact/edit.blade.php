...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('admincontact')}}"> Sữa trang liên hệ</a></li>
       
    </ol>
</section>
<section class="content">
    <div class="box box-primary">
        <form action="{{route('editcontact',$contacts[0]['id'])}}" method="POST" enctype="multipart/form-data" id="form-add-post" class="formcategory-add-insurance-company validate">
             @csrf
            <div class="box-header with-border">
                <h3 class="box-title">Sữa trang liên hệ</h3>
            </div>
            <div class="box-body">
                                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            @endphp
                                <div class="form-group">
                                    ...
                                    <input id="title_vi" name="address" required type="text" value="{{$contacts[0]['address']}}" class="form-control" placeholder="" onchange="changeInput(this.value)">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Hotline</label>
                                    <input  name="Hotline" required type="text" value="{{$contacts[0]['Hotline']}}" class="form-control" placeholder="" onchange="changeInput(this.value)">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Phone</label>
                                    <input  name="Phone" required type="text" value="{{$contacts[0]['Phone']}}" class="form-control" placeholder="" onchange="changeInput(this.value)">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">email</label>
                                    <input  name="email" required type="text" value="{{$contacts[0]['email']}}" class="form-control" placeholder="" onchange="changeInput(this.value)">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">web</label>
                                    <input  name="web" required type="text" value="{{$contacts[0]['web']}}" class="form-control" placeholder="" onchange="changeInput(this.value)">
                                </div>
                            </div>
            ...
            <div class="box-footer">
                <div class="row">
                    ...
                    <div class="col-md-6 text-left"><a id="btnBack" href="{{route('admincontact')}}" class="btn btn-default">Hủy</a></div>
                </div>
            </div>
        </form>
    </div>
