...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('adminproduct')}}"> Danh sách sản phẩm</a></li>
        <li class="active"> Sữa sản phẩm</li>
    </ol>
</section>
<section class="content">
    <div class="box box-primary">
        <form id="form-add-post" class="formcategory-add-insurance-company validate" method="post" action="{{route('editproduct',$product->id)}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="box-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active" id="vi" role="tabpanel" aria-labelledby="vi-tab">
                                <div class="form-group">
                                    ...
                                    <input id="title_vi" name="title_vi" required type="text" value="{{$product->name}}" class="form-control" placeholder="Nhập tiêu đề bài viết (VI)" onchange="changeInput(this.value)">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Mô tả (VI)</label>
                                    <textarea name="summary_vi" class="form-control ckeditor" placeholder="Nhập mô tả bài viết (VI)" value="">{!!$product->description!!}</textarea>
                                </div>
                            ...
                            <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                                <div class="form-group">
                                    ...
                                    <input id="title_en" name="title_en" required type="text" value="{{$product->name_en}}" class="form-control" placeholder="Nhập tiêu đề bài viết (EN)">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Mô tả (EN)</label>
                                    <textarea id="ckeditor" name="summary_en" class="form-control ckeditor" placeholder="Nhập mô tả bài viết (EN)">{!!$product->description_en!!}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <img src="project1/images/{{$product->image}}" alt="" class="preview-feature-image preview-image"/>
                        </div>
                        <div class="form-group">
            ...
            <div class="box-footer">
                <div class="row">
                    ...
                    <div class="col-md-6 text-left"><a id="btnBack" href="{{route('adminproduct')}}" class="btn btn-default">Hủy</a></div>
                </div>
            </div>
        </form>
    </div>
